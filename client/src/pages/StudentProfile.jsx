...
//         // Fetch the student profile from API
//         const response = await fetch(`http://localhost:4000/api/students/studentprofile/${studentName}`);
...
//         // Assuming the data format matches this structure
...
//         // setObservations([
//         //   { id: 1, metric: "Social Skills", observationText: "Works well in group settings" },
//         //   { id: 2, metric: "Academic Progress", observationText: "Shows strong understanding of math concepts" }
//         // ]);
...
//               <div key={observation.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
...
//         <button
//           className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center"
